...
/* list($profile_id, $profile) = each($variables['element']['view']['profile2']); */
//dpm($variables);
$profile_type = $variables['element']['#profile_type'];
/* dpm($profile, $profile_id); */
?>

<?php /*  if ($title && $profile_type != 'main' ): ?> */
