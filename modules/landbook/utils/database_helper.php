...
/**
 * @file
 * Provide database helpers
 *
 * The Landportal landbook
 *
 * This file originally comes from the landportal_uris module
 * This class abstracts all accesses to the database.
 *
 * Refactoring: Database config now in drupal
 * 
...
class DataBaseHelper {
  ...
  function __construct() {
    ...
    $this->db_name = $databases['default']['landbook']['database'];
  }
